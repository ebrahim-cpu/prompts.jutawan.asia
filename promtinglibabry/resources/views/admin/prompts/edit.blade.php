            ...
            <div class="bg-gray-800/50 backdrop-blur-sm rounded-2xl border border-white/10 overflow-hidden shadow-2xl">
                <form action="{{ route('admin.prompts.update', $prompt->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="p-8 space-y-6">
                        ...
                        <div x-data="{
                            selectedTags: {{ json_encode($prompt->getTagsArray()) }},
                        ...
                        <div>
                            ...
                            <textarea name="prompt_text" id="prompt_text" rows="5"
                                class="block w-full rounded-xl bg-gray-900/50 border-gray-700 text-white px-4 py-3 text-sm font-mono focus:ring-2 focus:ring-purple-500 focus:border-purple-500 transition" required>{{ old('prompt_text', $prompt->prompt_text) }}</textarea>
