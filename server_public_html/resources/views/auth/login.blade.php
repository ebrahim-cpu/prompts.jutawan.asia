<x-guest-layout>
    ...
    <div class="text-center space-y-5">
        ...
        <div>
            <h2 class="text-2xl font-extrabold text-white tracking-tight">Selamat Kembali</h2>
            <p class="text-gray-400 text-sm mt-1.5 max-w-sm mx-auto">
                Akses dan log masuk ke sistem ini adalah khusus menggunakan <strong class="text-white">Akaun Google</strong> sahaja.
            </p>
        </div>
        ...
        <div class="bg-gray-900/60 border border-white/10 rounded-xl p-4 text-xs text-gray-400 leading-relaxed text-left">
            <p class="font-bold text-gray-300 mb-1 flex items-center gap-1.5">
                <span>🔒 Akses Pantas & Selamat</span>
            </p>
            <p>Log masuk adalah selamat secara 1-klik melalui pengesahan Google OAuth tanpa perlu kata laluan manual.</p>
        </div>

        <p class="pt-2 text-center text-xs text-gray-500">
            Belum mendaftar akaun? 
            <a href="{{ route('auth.google') }}" class="text-pink-400 hover:text-pink-300 font-semibold transition">Daftar dengan Google</a>
        </p>
    </div>
</x-guest-layout>
