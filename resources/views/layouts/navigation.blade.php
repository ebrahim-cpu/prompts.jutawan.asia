                        ...
                        <div x-data="{ configOpen: false }" class="relative">
                            ...
                            <div x-show="configOpen" 
                                ...
                                <div class="py-1">
                                    ...
                                    <a href="{{ route('admin.reports.index') }}" class="flex items-center gap-2.5 px-3 py-2 rounded-xl text-sm font-medium transition {{ request()->routeIs('admin.reports.*') ? 'bg-purple-500/20 text-purple-300' : 'text-gray-300 hover:text-white hover:bg-white/10' }}">
                                ...
                                <div class="py-1">
                                    <div class="px-3 py-1.5 text-[10px] uppercase tracking-wider font-extrabold text-indigo-400">
                                        Pentadbiran Prompt
                                    </div>
        ...
        <div class="pt-2 pb-3 space-y-1 px-3">
            ...
            @if(auth()->check() && auth()->user()->role === 'admin')
                <div class="pt-3 pb-1 border-t border-white/5 my-2">
                    ...
                    <a href="{{ route('admin.reports.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg text-sm font-medium {{ request()->routeIs('admin.reports.*') ? 'bg-purple-500/20 text-purple-400' : 'text-gray-400 hover:text-white hover:bg-white/10' }}">
                        <span class="text-sm">📊</span>
                        Laporan Interactive
                    </a>
